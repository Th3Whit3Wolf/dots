...
function createPublisher(publisherName) {
    validation_1.validatePublisher(publisherName);
    util_1.log.warn('Creating a publisher via vsce is deprecated and will be removed soon. You can create a publisher directly in the Marketplace: https://aka.ms/vscode-create-publisher');
    return util_1.read(`Publisher human-friendly name: `, { default: publisherName })
        .then(displayName => {
