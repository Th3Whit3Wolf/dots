...
function windows.open_floating_window(BUFFER, BUFFER_NAME, IS_LOADED,floating_window_scaling_factor,floating_window_winblend)

    if floating_window_scaling_factor == nil then
        floating_window_scaling_factor = vim.g.floating_window_scaling_factor
    end
    if floating_window_winblend == nil then
        floating_window_winblend = vim.g.floating_window_winblend
    end
