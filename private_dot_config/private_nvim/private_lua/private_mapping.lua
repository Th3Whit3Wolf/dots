...
function mapping:load_plugin_define()
    self.plugin = {
        ...
        -- Barbar
        ["n|<Leader>bd"]       = Map_cu("BufferOrderByDirectory"):with_noremap():with_silent(),
        ["n|<Leader>bl"]       = Map_cr("BufferOrderByLanguage"):with_noremap():with_silent(),
        ["n|<A-,>"]            = Map_cr("BufferPrevious"):with_noremap():with_silent(),
        ["n|<A-.>"]            = Map_cr("BufferNext"):with_noremap():with_silent(),
        ...
        ["n|<A-9>"]            = Map_cr("BufferLast"):with_noremap():with_silent(),
        ["n|<C-x>"]            = Map_cr("BufferClose"):with_noremap():with_silent(),
